...
class Data_Processor(ABC):
    ...
    """
    Filters the data to exclude information that should not be visible to the DMM (for the purpose of preventing the system from "hacking" normative requirement fulfillment).
